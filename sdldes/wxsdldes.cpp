...
DialogBoxClass6::DialogBoxClass6(wxFrame *parent, char *title, Bool modal, int x, int y, int width, int height, long style, char *name):
...
DialogBoxClass6::~DialogBoxClass6(void)
{

}

void DialogBoxClass6::OnSize(int w, int h)
{
...
DialogBoxClass15::DialogBoxClass15(wxFrame *parent, char *title, Bool modal, int x, int y, int width, int height, long style, char *name):
  wxDialogBox(parent, title, modal, x, y, width, height, style, name)
{
  // Create panel items
...
DialogBoxClass15::~DialogBoxClass15(void)
{

}

void DialogBoxClass15::OnSize(int w, int h)
{
  wxDialogBox::OnSize(w, h);
}
...
DialogBoxClass25::DialogBoxClass25(wxFrame *parent, char *title, Bool modal, int x, int y, int width, int height, long style, char *name):
  wxDialogBox(parent, title, modal, x, y, width, height, style, name)
{
  // Create panel items
...
DialogBoxClass25::~DialogBoxClass25(void)
{

}

void DialogBoxClass25::OnSize(int w, int h)
{
  wxDialogBox::OnSize(w, h);
}
